...
'''
    ...
    stage('UI TESTING') {
      dir('selenium') {
        ...
        mvn clean install "-Dremote=true" "-DseleniumGridURL=http://sivacena1996:f5b2cfad-6b2b-4b1b-bec4-6f382e71bdd5@ondemand.saucelabs.com:80/wd/hub" "-Dplatform=Windows" "-Dbrowser=Chrome" "-Dbrowserversion=51" "-Doverwrite.binaries=true"
          '''    
              }
           }
